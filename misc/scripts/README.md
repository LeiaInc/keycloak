...
---------------------------------------------------------------------------------------------------
org.keycloak:keycloak-services:jar:26.3.0-custom
\- org.twitter4j:twitter4j-core:jar:4.1.2:compile
org.keycloak:keycloak-crypto-fips1402:jar:26.3.0-custom
\- org.keycloak:keycloak-services:jar:26.3.0-custom:compile
   \- org.twitter4j:twitter4j-core:jar:4.1.2:compile
...
```
